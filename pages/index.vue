<template>
    <header class="text-transparent bg-clip-text bg-gradient-to-b from-persian-green to-persian-rose">
        <pre> .----------------.            ,,..    ,,
| .--------------. |         ,MF'``A.  db
| |        __    | |         6M   .M'
...
| '--------------' |         MM
 '----------------'</pre>
    ...
    <footer class="mt-2 sm:mt-4 md:mt-6 lg:mt-8 text-transparent bg-clip-text bg-gradient-to-b from-persian-rose to-persian-green">
        ...
        <blockquote class="pr-3 lg:pr-0 text-right">
            "All things change in a dynamic environment. <wbr>Your effort to remain what you are <wbr>is what limits you."
