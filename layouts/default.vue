            ...
            meta: [
                {
                    ...
                    content: "default-src 'self'; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com; connect-src 'self' https://cloudflareinsights.com https://www.google-analytics.com; child-src 'none'; object-src 'none'; base-uri 'self'; form-action 'self'",
                },
                {
